...
function Colors() {
	...
	return (
		<div className={`${style.colors} p-5`}>
			...
			<header>Color</header>
			<div className={`mt-2 border w-100 p-4 ${style.sampleContainer}`}>
			...
			<div className={`mt-2 border w-100 p-4 ${style.sampleContainer}`}>
				<div className="bg-primary p-2 mb-2 text-light">bgPrimary</div>
				<div className="bg-secondary text-light p-2 my-2">bgSecondary</div>
				<div className="bg-success text-light p-2 my-2">bgSuccess</div>
				<div className="bg-danger text-light p-2 my-2">bgDanger</div>
				<div className="bg-warning text-light p-2 my-2">bgWarning</div>
				<div className="bg-info text-light p-2 my-2">bgInfo</div>
				<div className="bg-light text-dark p-2 my-2">bgLight</div>
				<div className="bg-dark text-white p-2 my-2">bgDark</div>
				<div className="bg-white text-dark p-2 my-2">bgWhite</div>
				<div className="bg-transparent text-dark p-2 my-2">bgTransparent</div>
			</div>
