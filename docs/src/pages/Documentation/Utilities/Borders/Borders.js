		...
		<div className="p-5">
			...
			<div className={style.bdUtilites}>
				<div className=" p-4 mx-0 mt-2">
					...
					></span>
					<span
						className={`${style.borderType} border border-sucess ml-4`}
					></span>
					<span
					...
					></span>
					<span
						className={`${style.borderType} border border-white mt-2`}
					></span>
				</div>
			</div>
			<div>
			...
			<div className={style.bdUtilites}>
				<div className="p-4 mx-0 mt-2">
					...
					<span
						className={`${style.borderType} border rounded-top ml-4`}
					></span>
					<span
						className={`${style.borderType} border rounded-right ml-4`}
					></span>
					<span
						className={`${style.borderType} border rounded-left ml-4`}
					></span>
					<span
						className={`${style.borderType} border rounded-bottom ml-4`}
					></span>
					<span
						className={`${style.borderType} border rounded-circle ml-4`}
					></span>
